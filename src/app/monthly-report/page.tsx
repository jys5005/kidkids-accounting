...
const accountSummary: AccountRow[] = (() => {
  ...
  const amounts: Record<string, Partial<AccountRow>> = {
    ...
    '12211': { budget:5000000, income:0, accumIncome:2500000, balance:2500000, rate:50 },
    '12212': { budget:8000000, income:800000, accumIncome:4800000, balance:3200000, rate:60 },
    '12213': { budget:36000000, income:1234896, accumIncome:14161527, balance:21838473, rate:39 },
    '12214': { budget:12000000, income:500000, accumIncome:6000000, balance:6000000, rate:50 },
    '12215': { budget:3000000, income:300000, accumIncome:2400000, balance:600000, rate:80 },
    '12216': { budget:5940318, income:200000, accumIncome:1600000, balance:4340318, rate:26 },
    ...
    '21423': { budget:9000000, expense:750000, accumExpense:8250000, balance:750000, rate:91 },
    '21424': { budget:9000000, expense:750000, accumExpense:8250000, balance:750000, rate:91 },
    ...
    '22171': { budget:3000000, expense:250000, accumExpense:2600000, balance:400000, rate:86 },
    '22172': { budget:3000000, expense:250000, accumExpense:2600000, balance:400000, rate:86 },
