  ...
  return (
    <div className="p-3 space-y-3">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button onClick={() => { resetForm(); setShowPopup(true) }} className="px-4 py-1.5 text-xs font-bold text-white bg-teal-500 hover:bg-teal-600 rounded transition-colors">신규 작성</button>
